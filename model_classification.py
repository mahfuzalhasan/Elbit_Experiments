...
class I3D(torch.nn.Module):
    def __init__(self,
        ...
        self.concatenated_output_conv = Unit3Dpy(
            out_channels=1024,
            in_channels=2016,
            kernel_size=(1, 1, 1),
            stride=(1, 1, 1),
        ...
        self.maxPool3d_concatenated_2x2 = MaxPool3dTFPadding(
            kernel_size=(2, 2, 2), stride=(2, 2, 2), padding='SAME')
    ...
    def forward(self, inp, tubes):
        ...
        ##print('out before inception 1: ',out.size())
        Mixed_2c = self.conv3d_2c_3x3(out) ## TODO skip from here
        #print('Mixed_2c: ',Mixed_2c.size())
        out = self.maxPool3d_3a_3x3(Mixed_2c) # sptial 8 times. temnporal 2
        # Mixed_3b = self.mixed_3b(out)
        #print('out before inception mixed_3b: ',out.size())
        out = self.mixed_3b(out)
        #print('out before inception mixed_3c: ',out.size())
        Mixed_3c = self.mixed_3c(out)
        #print('out from inception mixed_3c: ',Mixed_3c.size())
        ...
        feature_mixed_5c = self.extract_feature( tubes, out, input_shape )
        feature_mixed_5c = torch.stack(feature_mixed_5c,dim=0)
        #print('feature mixed 5c: ',feature_mixed_5c.size())
        ...
        #print('3c: ',feature_mixed_3c.size())
        #print('4d: ',feature_mixed_4d.size())
        #print('5c: ',feature_mixed_5c.size())
        

        concatenated_out = torch.cat((feature_mixed_3c, feature_mixed_4d, feature_mixed_5c),dim=1)
        #print('concatenated_out: ', concatenated_out.size()) 
        
        out = self.concatenated_output_conv(concatenated_out)
        #out = self.maxPool3d_concatenated_2x2(out)
...
if __name__ == "__main__":
    ...
    for i in range(10):
        ...
        saved_model_file = "/home/c3-0/mahfuz/MEVA_results/models/03-19-20_1816/model_37.pth"
        model.load_state_dict(torch.load(saved_model_file)['state_dict'])
