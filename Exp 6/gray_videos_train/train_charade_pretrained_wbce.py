...
def train(run_id, epoch, train_dataloader, model, optimizer, criterion, criterion_classification, writer, use_cuda, lr_scheduler=None, lr_list= None):
    ...
    for i, (inputs, tubes, targets, label_masks, _) in enumerate(train_dataloader):
        ...
        total_loss = criterion_classification.forward( class_label, targets )
...
def weight_distribution(train_dataset):
    ...
    #print('pos part weights: ',pos_weights)
    #print('neg part weights: ',neg_weights)
...
def train_locator( run_id, use_cuda ):
    ...
    saved_previous_file = '/home/c3-0/mahfuz/Elbit_results/models/06-03-20_1702/model_19.pth'#'/home/c3-0/mahfuz/Elbit_results/models/05-25-20_1432/model_7.pth'
